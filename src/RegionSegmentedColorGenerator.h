...
protected:
  ...
  public:
    ...
    virtual const char * what() const throw() { return "RegionSegmentedColorGenerator::calcImage(): can't segment image without any loaded threshold maps"; }
  };
...
/*! @file
 * @brief Describes RegionSegmentedColorGenerator, which generates FilterBankEvents indexed color images based on a color threshold file
 * @author jchen4 (Creator)
 * @author caryy (Creator)
 */
